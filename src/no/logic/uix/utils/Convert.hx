...
/*	
	...
	public static function toString( value:*, parseObjects:Boolean=false ):String
	{
		switch (typeof(value)) 
		{
			case "String":
				...
				break;
			case "Object":
				//var pack:String = getQualifiedClassName(value);
				//if (pack.indexOf("::")!=-1)
					//return pack.split("::")[1];
				//else
					//return pack;
				...
				{
					var oName:String = "[" + NameUtil.getUnqualifiedClassName(value) + "]";
					if (oName == "[object Object]")
						return "{ "+ObjUtils.toString(value) + " }";
					else
						return oName;
				}
